...
base_image_path = "Vyborg_vgg19_2000_4_at_iteration_100_vgg19_200_3_at_iteration_60.png" # "https://i.imgur.com/F28w3Ac.jpg")
style_reference_image_path = "1.jpg" # "https://i.imgur.com/9ooB60I.jpg")
iterations = 200
...
result_prefix = f"/home/van_rossum/Документы/neurofrankenstyle/result/{base_image_path[:-4]}_vgg19_{iterations}"
...
# model = vgg16.VGG16(weights="vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5", include_top=False)
...
## List of layers to use for the style loss.: VGG16 and VGG19
style_layer_names = [
    "block1_conv1",
    "block2_conv1",
    "block3_conv1",
...
# style_layer_names = [ # List of layers to use for the style loss.:: for MobileNet
#     "conv1",
#     "conv_pw_1",
#     "conv_pw_2",
#     "conv_pw_3",
